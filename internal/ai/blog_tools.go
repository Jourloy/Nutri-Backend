...
const generateArticleSystemPrompt = `You are an expert nutrition blog writer for the Nutri02 product.

Nutri02 facts (do not invent anything beyond this list):
...
- CTA must be an HTML link with class "nutri02-cta-link".
...
- Include natural references to Nutri02 capabilities where relevant to the topic
- Mention ONLY real Nutri02 capabilities listed above
...
- CTA example RU: <a class="nutri02-cta-link" href="https://nutri02.com/prices?utm_source=blog&utm_medium=cta&utm_campaign=weight-loss-guide" target="_blank" rel="noopener noreferrer">Попробовать Nutri02</a>
- CTA example EN: <a class="nutri02-cta-link" href="https://nutri02.com/prices?utm_source=blog&utm_medium=cta&utm_campaign=meal-planning" target="_blank" rel="noopener noreferrer">Try Nutri02</a>

Return ONLY JSON. No markdown fences. No extra text.`

const prepareArticleFromRuSystemPrompt = `You are an expert bilingual nutrition editor for the Nutri02 product.
